...
import metalLogo from './assets/metal-logo.svg';
...
const tld = '.metal';
const CONTRACT_ADDRESS = '0x144402fAC1493C80fA94E48adD328AEA522d0852';
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img src="https://media.giphy.com/media/NuBHQY1PfaXU4/giphy.gif" alt="Metal gif" />
	  ...
	  return (
		<div className="form-container">
		  ...
		  <input
			type="text"
			value={record}
			placeholder='whats ur metal power?'
